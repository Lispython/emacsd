...
virtualenv --python=python2.6 --no-site-packages --clear $VENV
source "$VENV/bin/activate"

$VENV/bin/easy_install pip
$PIP_PATH install -E $VENV -U ipython

#$PIP_PATH install -E venv  http://pymacs.progiciels-bpi.ca/archives/Pymacs-0.23.tar.gz
$PIP_PATH install -E $VENV -U -e hg+http://bitbucket.org/agr/rope#egg=rope
rm -rf /tmp/rope
...
$PIP_PATH install -E $VENV -U /tmp/rope/ropemacs
